Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/thiagoramos23/PNChart"
  ...
  s.author       = { "Kevin" => "kevinchou.c@gmail.com", "Thiago Ramos" => "thiagoramos.al@gmail.com" }

  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/thiagoramos23/PNChart.git" }

  s.ios.dependency 'UICountingLabel', '~> 1.0.0'

  s.source_files = 'PNChart/*'
